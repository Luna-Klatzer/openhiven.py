...
class HTTPClient():
    ...
    def __init__(self, loop: Optional[asyncio.AbstractEventLoop] = asyncio.get_event_loop(), **kwargs):
        ...
        self._TOKEN = kwargs.get('token', "https://api.hiven.io")
        self.api_url = kwargs.get('api_url', "v1")
        self.api_version = kwargs.get('api_version')
        self.request_url = request_url_format.format(self.api_url, self.api_version)        
        
        self.headers = {"Content-Type": "application/json", "Authorization": self._TOKEN}
    ...
    async def request(self, endpoint: str, data: dict = None, timeout: int = 15) -> dict:
    ...
    async def post(self, endpoint: str, data: dict = None) -> bool:
    ...
    async def delete(self, endpoint: str, data: dict = None) -> bool:
        """`openhivenpy.Gateway.HTTPClient.delete()`
    ...
    async def put(self, endpoint: str, data: dict = None) -> bool:
    ...
    async def patch(self, endpoint: str, data: dict = None) -> bool:
    ...
    async def options(self, endpoint: str, data: dict = None) -> bool:
